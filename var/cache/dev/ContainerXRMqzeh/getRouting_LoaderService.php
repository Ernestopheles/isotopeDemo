...
class getRouting_LoaderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(($container->privates['contao.routing.frontend_loader'] ?? ($container->privates['contao.routing.frontend_loader'] = new \Contao\CoreBundle\Routing\FrontendLoader(true, '.html'))));
        $a->addLoader($c);
