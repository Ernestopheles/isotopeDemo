...
class __TwigTemplate_1b56b1cfc1f30edf503efa6a2b5251ad extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        $macros = $this->macros;
        echo twig_sprintf($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("XPT.hint", [], "contao_exception"), ($context["template"] ?? null));
    }
    ...
    {
        return new Source("", "@ContaoCore/Error/layout.html.twig", "/shared/httpd/isotope/isotopeDemo/vendor/contao/core-bundle/src/Resources/views/Error/layout.html.twig");
    }
}
