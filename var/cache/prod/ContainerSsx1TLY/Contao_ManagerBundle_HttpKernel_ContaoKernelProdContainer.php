...
class Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yQzmeKuT+q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4po50sgGWZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getContao_Twig_FilesystemLoaderWarmerService()
    {
        ...
        return $this->privates['contao.twig.filesystem_loader_warmer'] = new \Contao\CoreBundle\Twig\Loader\ContaoFilesystemLoaderWarmer($a, $b, \dirname(__DIR__, 4), $this->targetDir.'', 'prod');
    }
